...
static const BoardPmuPins_t AMOLED_241_PMU_PINS =  {47/*SDA*/, 48/*SCL*/, -1/*IRQ*/};
static const BoardTouchPins_t AMOLED_241_TOUCH_PINS =  {47/*SDA*/, 48/*SCL*/, -1/*IRQ*/, -1/*RST*/};
...
static const  BoardsConfigure_t BOARD_AMOLED_241 = {
  RM690B0_AMOLED,
  NULL,//&AMOLED_241_TOUCH_PINS, //Touch CS226SE
  &AMOLED_241_PMU_PINS,    //PMU
  NULL,    //SENSOR
  NULL,//&AMOLED_241_SD_PINS,//SDCard
...
public:
    ...
    // 1.91 Inc AMOLED(RM67162) S3R8
    bool beginAMOLED_191(bool touchFunc = true);

    //  1.47 Inc AMOLED(SH8501) S3R8
